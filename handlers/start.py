...
async def gstart(_, message: Message):
      await message.reply_text("""**Nature - Music** __Telah Online, Tekan Tombol di Bawah Untuk Melihat Panduan!!__""",
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
